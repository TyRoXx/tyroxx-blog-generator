tags::h3(tags::link("#", "how-to-choose-an-integer-type",
    ...
    text("Prefer portable types like ") + inline_code("std::uint32_t") +
    ...
    tags::p(
        ...
        "cargo-culting it?") +
    text("If you know that you are dealing with 64-bit file sizes, document "
    ...
    text("One of the few valid use cases for the built-in types is overloading "
         "a function for all integer types that exist:") +
    snippet_from_file(
        snippets_source_code,
        ventura::relative_path("how-to-choose-an-integer-type-1.cpp")) +
    text("This kind of code should be fairly uncommon though.") + tags::p("") +
    ...
    text("These are my thoughts when I read this function. I tried to mark the "
    ...
    text("I only have to change one little thing to make all these WTFs go "
         "away:") +
    snippet_from_file(
        snippets_source_code,
